...
// Function to remove expired events
function removeExpiredEvents($conn) {
    $today = date('Y-m-d');
    $sql = "DELETE FROM events WHERE end_date < '$today'";
    if ($conn->query($sql)) {
        return true;
    }
    return false;
...
$tables = [
    ...
    'announcements' => ['icon' => 'fa-bullhorn', 'color' => '#f1c40f', 'title' => 'Announcements']
];
...
// Get recent events (last 5 active or upcoming events)
$recentEvents = [];
$tableCheck = $conn->query("SHOW TABLES LIKE 'events'");
if ($tableCheck->num_rows > 0) {
    $today = date('Y-m-d');
    $sql = "SELECT * FROM events WHERE end_date >= '$today' ORDER BY start_date ASC LIMIT 5";
    $result = $conn->query($sql);
...
$recentTickets = [];
$tableCheck = $conn->query("SHOW TABLES LIKE 'help_desk'");
if ($tableCheck->num_rows > 0) {
...
$totalUsers = isset($counts['users']) ? $counts['users'] : 0;

// Get total workshops count
$totalWorkshops = isset($counts['workshops']) ? $counts['workshops'] : 0;

// Get total workshop registrations
$totalRegistrations = isset($counts['workshop_registrations']) ? $counts['workshop_registrations'] : 0;
        ...
        <div class="main-content">
                ...
                <div class="card-body">
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><?php echo isset($counts['help_desk']) ? $counts['help_desk'] : 0; ?></h3>
                ...
                <div class="card-body">
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><?php echo isset($counts[$table]) ? $counts[$table] : 0; ?></h3>
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Recent Events</h2>
                        <a href="admin_event.php" class="btn btn-sm btn-outline">View All</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <?php if (count($recentEvents) > 0): ?>
                                        <?php foreach ($recentEvents as $event): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $event['name'] ?? 'Event #' . $event['id']; ?></td>
                                                <td><?php echo $event['start_date'] ?? 'N/A'; ?></td>
                                                <td>
                                                    <?php 
                                                    $today = date('Y-m-d');
                                                    $status = 'active';
                                                ...
                                                <td>
                                                    <a href="admin_event.php" class="btn btn-sm">Manage</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="admin_help_desk.php" class="btn btn-sm btn-outline">View All</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table>
                ...
                <div class="card-body">
                    <div class="quick-actions">
                        ...
                        <div class="action-card">
                            ...
                            <a href="admin_event.php" class="btn">Create Event</a>
                        </div>
                        ...
                        <div class="action-card">
                            ...
                            <a href="admin_workshop.php" class="btn">Create Workshop</a>
                        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Manage meeting minutes and records</p>
                            <a href="../Meeting/admin_meetings.php" class="btn btn-primary">
                                <i class="fas fa-clipboard-list"></i> Manage Meetings
                            </a>
                        </div>
                    </div>
                </div>
            ...
            var tableData = {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php 
                        foreach ($selectedTables as $table) {
                            echo (isset($counts[$table]) ? $counts[$table] : 0) . ", ";
                        }
                        ?>
                    ],
                    backgroundColor: [
